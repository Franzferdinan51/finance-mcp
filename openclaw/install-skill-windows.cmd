...
copy /Y "%~dp0..\finance-core.js" "%TARGET%\finance-core.js" >nul
copy /Y "%~dp0..\server.js" "%TARGET%\server.js" >nul
copy /Y "%~dp0..\package.json" "%TARGET%\package.json" >nul
copy /Y "%~dp0..\package-lock.json" "%TARGET%\package-lock.json" >nul
